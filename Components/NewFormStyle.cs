...
namespace Gui.Components
{
    public partial class NewFormStyle : Component
    {
        ...
        public Size IconSize { get; set; } = new Size(14, 14); // Размер икноки формы

        #endregion
        #region -- Поля --

        private Dictionary<fStyle, Style> StylesDictionary; // Словарь вида: <Стиль из набора, Объект стиля с параметрами>
        private Style CurrentStyle; // Актуальный стиль, класс с его параметрамы
        ...
        {
            StylesDictionary = new Dictionary<fStyle, Style>();
            ...
            // Стиль My
            StylesDictionary.Add(fStyle.My,
                new Style()
                {
                    ...
                    HeaderTextFont = new Font("Trebuchet MS", 10F, FontStyle.Bold),
        ...
        private void SaveNoneStyleConfig()
        {
            ...
            {
                Style NoneStyle = StylesDictionary[fStyle.None];
        ...
        private void SaveUserStyleConfig()
        {
            if (StylesDictionary.ContainsKey(fStyle.UserStyle) && StyleUsed == false)
            {
                ...
                Style UserStyle = StylesDictionary[fStyle.UserStyle];
